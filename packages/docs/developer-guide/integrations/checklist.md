...
Celo has a [lightweight identity protocol](https://github.com/medhak1/celo-monorepo/tree/511e7fd333eb71e87d861e2b4f082e967dadb145/celo-codebase/protocol/identity/README.md) that allows users to address each other via their phone number instead of addresses that Celo wallets should implement. Since user privacy is important, Celo wallets should leverage the built-in [Phone Number Privacy protocol](https://github.com/medhak1/celo-monorepo/tree/511e7fd333eb71e87d861e2b4f082e967dadb145/celo-codebase/protocol/identity/phone-number-privacy/README.md) to protect against large-scale harvesting of user phone numbers.
